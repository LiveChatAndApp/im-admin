...
-- 傾印  資料表 wfchat.t_sensitive_messages 結構
CREATE TABLE IF NOT EXISTS `t_sensitive_messages` (
...
-- 正在傾印表格  wfchat.t_sensitive_messages 的資料：~0 rows (近似值)
/*!40000 ALTER TABLE `t_sensitive_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_sensitive_messages` ENABLE KEYS */;
