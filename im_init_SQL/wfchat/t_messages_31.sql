...
-- 傾印  資料表 wfchat.t_messages_31 結構
CREATE TABLE IF NOT EXISTS `t_messages_31` (
  ...
  KEY `messages31_conv_index` (`_type`,`_target`,`_line`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_messages_31 的資料：~0 rows (近似值)
/*!40000 ALTER TABLE `t_messages_31` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_messages_31` ENABLE KEYS */;
