...
-- 傾印  資料表 wfchat.t_user_messages_118 結構
CREATE TABLE IF NOT EXISTS `t_user_messages_118` (
  ...
  KEY `user_messages118_mid_index` (`_mid`),
  KEY `user_messages_conv_index` (`_uid`,`_type`,`_target`,`_line`,`_mid` DESC)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_user_messages_118 的資料：~6 rows (近似值)
/*!40000 ALTER TABLE `t_user_messages_118` DISABLE KEYS */;
INSERT INTO `t_user_messages_118` (`id`, `_mid`, `_uid`, `_seq`, `_dt`, `_line`, `_type`, `_target`, `_directing`, `_cont_type`) VALUES
	(1, 331707853517651969, 'wygqmws2k', 331707853517651969, '2023-01-05 16:17:10', 0, 1, 'qygqmws2k', 0, 1);
/*!40000 ALTER TABLE `t_user_messages_118` ENABLE KEYS */;
