...
-- 傾印  資料表 wfchat.t_user_messages_66 結構
CREATE TABLE IF NOT EXISTS `t_user_messages_66` (
  ...
  KEY `user_messages66_mid_index` (`_mid`),
  KEY `user_messages_conv_index` (`_uid`,`_type`,`_target`,`_line`,`_mid` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_user_messages_66 的資料：~0 rows (近似值)
/*!40000 ALTER TABLE `t_user_messages_66` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_user_messages_66` ENABLE KEYS */;
