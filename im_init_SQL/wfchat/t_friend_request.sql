...
-- 傾印  資料表 wfchat.t_friend_request 結構
CREATE TABLE IF NOT EXISTS `t_friend_request` (
  ...
  `_reason` text COLLATE utf8mb4_unicode_ci,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fr_user_target_index` (`_uid`,`_friend_uid`),
  KEY `friend_request_uid_index` (`_friend_uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_friend_request 的資料：~0 rows (近似值)
