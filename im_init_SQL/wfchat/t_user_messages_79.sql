...
-- 傾印  資料表 wfchat.t_user_messages_79 結構
CREATE TABLE IF NOT EXISTS `t_user_messages_79` (
  ...
  KEY `user_messages79_mid_index` (`_mid`),
  KEY `user_messages_conv_index` (`_uid`,`_type`,`_target`,`_line`,`_mid` DESC)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_user_messages_79 的資料：~116 rows (近似值)
/*!40000 ALTER TABLE `t_user_messages_79` DISABLE KEYS */;
INSERT INTO `t_user_messages_79` (`id`, `_mid`, `_uid`, `_seq`, `_dt`, `_line`, `_type`, `_target`, `_directing`, `_cont_type`) VALUES
	(1, 331707596792692737, 'admin', 331707596792692737, '2023-01-05 16:15:07', 0, 0, '4ygqmws2k', 0, 1);
/*!40000 ALTER TABLE `t_user_messages_79` ENABLE KEYS */;
