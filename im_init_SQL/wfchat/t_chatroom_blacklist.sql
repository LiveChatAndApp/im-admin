...
-- 傾印  資料表 wfchat.t_chatroom_blacklist 結構
CREATE TABLE IF NOT EXISTS `t_chatroom_blacklist` (
  ...
  `_expired_time` bigint NOT NULL,
  `_dt` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cr_bl_uid_index` (`_cid`,`_uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在傾印表格  wfchat.t_chatroom_blacklist 的資料：~0 rows (近似值)
