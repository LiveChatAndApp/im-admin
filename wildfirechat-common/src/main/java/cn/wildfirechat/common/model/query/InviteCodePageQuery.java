...
@NoArgsConstructor
@AllArgsConstructor
public class InviteCodePageQuery {
    private String inviteCode; // 邀请码

    private Integer friendsDefaultType; // 预设好友模式 1: 所有, 2: 轮询[InviteCodeDefaultFriendTypeEnum]

    private Integer status; // 状态 状态 0: 停用, 1: 使用中 [InviteCodeStatusEnum]
    ...
    private Date registerTimeGt;// 创建时间开始

    private Date registerTimeLe;// 创建时间结束
}
